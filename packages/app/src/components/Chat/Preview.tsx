  ...
  return (
    <FlexColStart className="w-full h-full min-h-[500px] max-w-[350px] rounded-lg bg-white-100 shadow-lg overflow-hidden relative ">
      ...
      <FlexColStart className={cn("w-full h-auto p-4 ", "bg-blue-100")}>
        <p className={cn("text-[15px] text-white-100 font-jbEB")}>{botName.length > 0 ? botName : "ChatBot"}</p>
      </FlexColStart>
      <br />
      {/* Messages */}
      <FlexColStart className="w-full h-full px-3">
        <FlexColEnd className="w-full">
          <FlexRowCenterBtw className="w-fit">
            ...
            >
              <span className="text-white-100 text-[11px] font-jbSB ">
                User message here!!
              </span>
            </FlexColStart>
          </FlexRowCenterBtw>
        ...
        <FlexColStart className="w-full">
          <FlexRowStartBtw className="w-fit">
            ...
            <FlexColStart
              className={"w-fit"}
            >
              <span className="text-dark-200 text-[11px] font-jbSB w-fit max-w-[200px] px-4 py-2 h-auto rounded-lg bg-white-500 leading-[15px] ">
